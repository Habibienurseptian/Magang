...
<div class="container py-4">
    ...
    <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.kompetensi.update', $kompetensi->id) }}">
                @csrf
                @method('PUT')
                <div class="row g-3">
                    <div class="col-md-4">
                    ...
                    <div class="col-12 text-end">
                        <a href="{{ route('admin.kompetensi.index') }}" class="btn btn-secondary me-2"><i class="fa fa-arrow-left me-1"></i> Batal</a>
