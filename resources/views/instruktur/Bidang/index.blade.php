...
<div class="container py-4">
    ...
    <div class="card mb-4 shadow-sm border-0" style="border-radius:1.2rem;">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('instruktur.bidang.store') }}">
                @csrf
                ...
                <table class="table table-bordered align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $skill->name }}</td>
                            <td>
                                <form method="POST" action="{{ route('instruktur.bidang.destroy', $skill->id) }}" class="d-inline" onsubmit="return confirm('Hapus bidang ini?')">
                                    @csrf
                                    @method('DELETE')
