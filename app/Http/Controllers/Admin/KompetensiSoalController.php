...
class KompetensiSoalController extends Controller
{
    ...
    public function index($kompetensiId)
    {
        ...
        return view('admin.kompetensi.soal.index', compact('kompetensi', 'soals'));
    }
    ...
    public function edit($kompetensiId, $soalId)
    {
        ...
        return view('admin.kompetensi.soal.edit', compact('kompetensi', 'soal'));
    }
    ...
    public function update(Request $request, $kompetensiId, $soalId)
    {
        ...
        return redirect()->route('admin.kompetensi.soal.index', $kompetensiId)->with('success', 'Soal berhasil diupdate.');
    }
