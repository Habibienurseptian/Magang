...
class SoalController extends Controller
{
    ...
    public function index($competencyId)
    {
        ...
        return view('admin.kompetensi.soal.index', compact('competency', 'soals'));
    }
    ...
    public function edit($competencyId, $soalId)
    {
        ...
        return view('admin.kompetensi.soal.edit', compact('competency', 'soal'));
    }
    ...
    public function update(Request $request, $competencyId, $soalId)
    {
        ...
        return redirect()->route('admin.kompetensi.soal.index', $competencyId)->with('success', 'Soal berhasil diupdate.');
    }
